// src/components/simuladores/InteresCompuesto.jsx
  ...
  const calcular = (e) => {
    ...
    switch (modo) {
      case "monto_futuro": {
        ...
        res = inputs.capital * Math.pow(1 + tasaMensual / 100, tiempoMeses);
        unidad = "COP";
        break;
      }
      case "tasa": {
        ...
        res =
          (Math.pow(inputs.monto / inputs.capital, 1 / tiempoMeses) - 1) * 100;
        unidad = "% mensual";
        break;
      }
      case "tiempo": {
        ...
        res =
          Math.log(inputs.monto / inputs.capital) /
